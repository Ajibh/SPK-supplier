...
<div class="d-sm-flex align-items-center justify-content-between">
	<div class="pagetitle d-flex align-items-center">
		<h1 class="me-3">Data Sub Kriteria</h1>
		<nav>
			...
			<div class="card-body">
				<div class="d-sm-flex align-items-center justify-content-between">
					...
					<button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
						data-bs-target="#tambah<?= $data['id_kriteria']; ?>">
						<i class="bi bi-plus text-white"></i>Tambah
					</button>
				</div>

				<div class="modal fade" id="tambah<?= $data['id_kriteria']; ?>" tabindex="-1" role="dialog"
							...
							<form action="" method="post">
								<div class="modal-body">
									...
									<div class="form-group">
										...
										<input autocomplete="off" step="0.001" type="number" name="nilai" class="form-control"
											required>
									</div>
								</div>
								<div class="modal-footer">
									...
									<button type="submit" name="tambah" class="btn btn-success btn-sm"><i class="fa fa-save"></i>
										Simpan</button>
								</div>
							</form>
						</div>
						...
						<tbody>
							...
							while ($d = mysqli_fetch_array($q)) {
								...
								<tr align="center">
									...
									<td>
										<div role="group">
											<a data-bs-toggle="modal" data-bs-target="#editsk<?= $d['id_sub_kriteria'] ?>"
												title="Edit Data" href="#"><i class="bi bi-pencil-square"
													style="margin-right: 10px;"></i></a>
											<a data-toggle="tooltip" data-placement="bottom" title="Hapus Data"
												href="hapus-sub-kriteria.php?id=<?php echo $d['id_sub_kriteria']; ?>"
												onclick="return confirm ('Apakah anda yakin untuk menghapus data ini')"><i
													class="bi bi-trash ml-10"></i></a>
										</div>
									</td>
								</tr>

								<!-- Modal -->
								<div class="modal fade" id="editsk<?= $d['id_sub_kriteria'] ?>" tabindex="-1" role="dialog"
									aria-labelledby="myModalLabel" aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
											...
											<form action="list-sub-kriteria.php?id=<?php echo $d['id_sub_kriteria']; ?>"
												method="post">
												<input type="text" name="id_sub_kriteria" value="<?= $d['id_sub_kriteria']; ?>"
													hidden>
												<div class="modal-body">
													...
													<div class="form-group">
														...
														<input type="text" autocomplete="off" class="form-control"
															value="<?= $d['nama'] ?>" name="nama" required>
													</div>
													<div class="form-group">
														<label class="font-weight-bold">Nilai</label>
														<input type="number" step="0.001" autocomplete="off" name="nilai"
